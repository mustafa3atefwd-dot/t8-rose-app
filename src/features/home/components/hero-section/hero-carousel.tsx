      ...
      <div className="pointer-events-none absolute inset-0 z-20 flex flex-col justify-end p-6 text-white">
        <div className="max-w-lg space-y-4">
          ...
          <div className="pointer-events-auto pt-2 ltr:text-left rtl:text-right">
            <Button
              asChild
              className="bg-maroon-50 text-maroon-700 hover:bg-maroon-100 rounded-xl px-4 py-2.5 font-medium transition-colors"
            >
              <Link href={activeSlide.link}>{t('buying')}</Link>
            </Button>
          </div>
        </div>
      </div>
