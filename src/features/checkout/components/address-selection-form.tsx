          ...
          <div className="space-y-3">
            {addresses.map((address) => {
              ...
              return (
                <label
                  key={address.id}
                  className={`relative flex cursor-pointer items-center justify-between rounded-2xl border border-zinc-200 p-4 transition-all ${
                    isSelected
                ...
                >
                  ...
                  <div className="space-y-1">
                    ...
                    <p className={`text-sm ${isSelected ? 'text-zinc-100' : 'text-zinc-500'}`}>
                  ...
                  <div className="dir-ltr flex items-center gap-2">
                    ...
                    <span className={`text-sm font-medium ${isSelected ? 'text-white' : 'text-zinc-600'}`}>
                      {address.phone}
                    </span>
                  </div>
                </label>
