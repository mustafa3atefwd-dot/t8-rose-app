...
export function AccountSidebar() {
  ...
  return (
    <aside className="border-ds-border-muted bg-ds-bg-subtle flex max-h-screen w-full shrink-0 flex-col rounded-2xl border p-3 lg:w-64">
      ...
      <Button
        variant="ghost"
        className="bg-ds-bg-muted text-ds-text-danger hover:bg-ds-bg-danger-fade mt-3 justify-start gap-3 lg:mt-auto"
