        ...
        <div className="">
            ...
            <div className="h-22 pt-4.5 pr-9 pb-4.5 pl-9 gap-4 flex items-center">
                ...
                <div dir="ltr" className="group relative flex items-center max-sm:w-20 md:w-3/5">
                        <SearchInput className="w-full h-13 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-ds-xl border p-4 gap-2 border-zinc-300 placeholder:text-zinc-400 placeholder:pl-6 rtl:placeholder:pl-113" />
                        <Search className="rtl:ml-100 w-4.5 h-4.5 absolute ml-4 group-focus-within:hidden"/>
                </div>
