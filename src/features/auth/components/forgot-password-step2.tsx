...
import { ForgotPasswordStep2Props } from '../lib/types/forgot-password.type';
    ...
    <section className="w-full max-w-101.5 rtl:max-w-md">
      ...
      <header className="border-ds-border-muted mb-6 space-y-2.5 border-b pb-4">
        ...
        <div className="flex items-center gap-2.5">
          <div onClick={onBack} className="rounded-ds-lg bg-ds-bg-primary flex size-7.5 items-center justify-center cursor-pointer">
