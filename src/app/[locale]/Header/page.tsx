...
export default function Header() {
    return <>
        ...
        <div className="">
            {/* up */}
            <div className=" h-22 pt-4.5 pr-9 pb-4.5 pl-9 gap-4 flex ">
                {/* image */}
            ...
            <div className="h-11 flex justify-center items-center space-x-4 bg-ds-primary text-white dark:text-maroon-800">
                <div className="flex items-center p-3 gap-2">
                    ...
                    <button className="font-medium text-base leading-[100%] tracking-normal align-middle cursor-pointer">Home</button>
                </div>

                <div className="flex items-center p-3 gap-2">
                    <Gift className="w-5 h-5"/>
                    <button className="font-medium text-base leading-[100%] tracking-normal align-middle cursor-pointer">Products</button>
                </div>

                <div className="flex items-center p-3 gap-2">
                    <ClipboardList className="w-5 h-5"/>
                    <button className="font-medium text-base leading-[100%] tracking-normal align-middle cursor-pointer">Categories</button>
                </div>

                <div className="flex items-center p-3 gap-2">
                    <PartyPopper className="w-5 h-5"/>
                    <button className="font-medium text-base leading-[100%] tracking-normal align-middle cursor-pointer">Occasions</button>
                </div>

                <div className="flex items-center p-3 gap-2">
                    <Headset className="w-5 h-5"/>
                    <button className="font-medium text-base leading-[100%] tracking-normal align-middle cursor-pointer">Contact</button>
                </div>
                <div className="flex items-center p-3 gap-2">
                    <Info className="w-5 h-5"/>
                    <button className="font-medium text-base leading-[100%] tracking-normal align-middle cursor-pointer">About</button>
                </div>
            </div>
        </div>
    </>
