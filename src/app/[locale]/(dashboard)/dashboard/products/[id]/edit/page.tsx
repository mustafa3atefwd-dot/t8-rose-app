...
export default async function EditProductPage({ params }: PageProps) {
  ...
  return <div className="min-h-screen bg-ds-bg-subtle">
    ...
    <main className="min-w-0 p-4 md:p-6"><h1 title={pageTitle} className="mb-6 max-w-full truncate text-2xl font-semibold text-ds-text-plain">{pageTitle}</h1><ProductForm mode="edit" product={product} categories={categories} occasions={occasions} /></main>
  </div>;
}
