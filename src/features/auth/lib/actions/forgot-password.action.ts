...
import { ForgotPasswordStep1Response, ForgotPasswordStep3Response } from "../types/forgot-password.type";

//^ forgot password step 1
export async function forgetPasswordStep1(values:TForgotPasswordStep1Schema): Promise<ForgotPasswordStep1Response>{
    try {
         const response = await fetch('https://rose-app.elevate-bootcamp.cloud/api/auth/forgot-password',{
        method: 'POST',
        headers: {
...
export async function forgetPasswordStep3(values:TForgotPasswordStep3Schema): Promise<ForgotPasswordStep3Response>{
    try {
         const response = await fetch('https://rose-app.elevate-bootcamp.cloud/api/auth/reset-password',{
        method: 'POST',
        headers: {
            "Content-Type": "application/json",
            "Accept": "application/json",
